...
function Formulaire() {
  ...
  useEffect(()=>{
    Axios.get(`http://localhost:3001/user/${id}`).then(res=>{ setInputs(res.data); })
            },[]);


      const handleSubmit=(event)=>{
        event.preventDefault();
        Axios.put(`http://localhost:3001/user/${id}`,inputs).then(res=>{
            console.log(res);
            navigate("/listeusers")
          })
    }
...
<section className=" gradient-custom">
              ...
              <div className="card bg-dark text-white" style={{borderRadius: '1rem'}}>
                <div className="card-body p-5 text-center">
                  <div className="mb-md-5 mt-md-4 pb-5">
                    <h2 className="fw-bold mb-2 text-uppercase">Modify</h2>
                    <p className="text-white-50 mb-5">please check your information !</p>
                    ...
                    <div className="form-outline form-white mb-4">
                      <input   type="text" id="typePasswordX" name="password" className="form-control form-control-lg" value={inputs.password} onChange={(e)=>handleChange(e)} />
      ...
      <div className="input-group mb-3">
        <div className="input-group-prepend">
          <span className="input-group-text" id="basic-addon1"><i class="fa-brands fa-twitter fa-lg"></i></span>
        </div>
        <input type="text" name="ls"  value={inputs.ls} onChange={(e)=>handleChange(e)} className="form-control" placeholder="your skype link !" aria-label="Username" aria-describedby="basic-addon1" />
      </div>
      ...
      <div className="input-group mb-3">
        ...
        <input type="text" name="lim"   value={inputs.lim} onChange={(e)=>handleChange(e)} className="form-control" placeholder="your image link !" aria-label="Username" aria-describedby="basic-addon1" />
                    ...
                    <div><input  required  className="btn btn-outline-light btn-lg px-5" type="submit" value="Valider"/></div>
