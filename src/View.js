...
function View() {
  ...
  const {id}=useParams();
  const a7a = "mailto:"+inputs.email;
  const a7b = "wrapper "+inputs.mode;
...
<div  className=" gradient-custom" onSubmit={(event)=>handleSubmit(event)}>
...
<div>
        ...
        <div class="lines"></div>
          <div className="profile-card js-profile-card">
            <div className="profile-card__img">
              <img src={inputs.lim} alt="profile card imgBx" />
            </div>
            <div className="profile-card__cnt js-profile-cnt content">
              <div className="profile-card__name details">{inputs.name}</div>
              <div className="profile-card__txt   details">{inputs.adress}</div>
              <div className="profile-card-loc   details">
                <span className="profile-card-loc__icon details">
                  <svg className="icon"><use xlinkHref="#icon-location" /></svg>
                </span>
                <span className="profile-card-loc__txt"> Tunisia,{inputs.country} </span>
              </div>
              <div className="profile-card-social">
                <a href={inputs.lf} className="profile-card-social__item facebook" target="_blank">
                  <span className="icon-font">
                    <svg className="icon"><use xlinkHref="#icon-facebook" /></svg>
                  </span>
                </a>
                <a href={inputs.ls} className="profile-card-social__item twitter" target="_blank">
                  <span className="icon-font">
                    <svg className="icon"><use xlinkHref="#icon-twitter" /></svg>
                  </span>
                </a>
                <a href={inputs.li} className="profile-card-social__item instagram" target="_blank">
                  <span className="icon-font">
                    <svg className="icon"><use xlinkHref="#icon-instagram" /></svg>
                  </span>
                </a>
                <a href={inputs.lg} className="profile-card-social__item github" target="_blank">
                  <span className="icon-font">
              ...
              <div className="profile-card-ctr">
                ...
                <a  style={{textDecoration: 'none', color : 'white'}} href= {a7a} >Email Us</a>
                </button>
                <button className="profile-card__button button--orange">Print </button>
              </div>
            </div>
      ...
      <footer class="footer">
        <p class="trademark">Get your card on 
